  ...
  return (
    <div className='item'>
      <a href="#delete" className='item__remove'>
        <svg className='item__remove-svg' width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className='item__counter'>
        <button
          className={cn('item__button', {'unactive-button': test})}
        >
          <svg className={cn('item__button-svg', {'unactive-button-svg': test})} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button className='item__button'>
          <svg className='item__button-svg' width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
