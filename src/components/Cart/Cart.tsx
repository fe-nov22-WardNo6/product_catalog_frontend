...
export const Cart: React.FC = () => {
  return (
    <div className='conteiner'>
      ...
      >
        <svg className='cart__link-svg' width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className='cart__flex'>
        ...
        <div className='cart__total'>
          ...
          <a className='cart__total-link' href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">
