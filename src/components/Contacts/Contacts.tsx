      ...
      <div className='dev'>
        ...
        <div className='dev__information'>
          <p className='dev__text-main'>
            Email:&nbsp;&nbsp;
            <a className='dev__text-normal' href = "mailto: anton.zhytonbaiev.dev@gmail.com">anton.zhytonbaiev.dev@gmail.com</a>
          </p>
          <p className='dev__text-main'>
            LinkedIn:&nbsp;&nbsp;
            <a 
          ...
          <p className='dev__text-main'>
            <a className='dev__text-normal' href="http://github.com/Anton-Zhytonbaiev">GitHub</a>
          </p>
        </div>
        <div className='dev__information'>
          <p className='dev__text-main'>
            Telegram:  @Anton_Zhytonbaiev
          </p>
